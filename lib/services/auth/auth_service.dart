  ...
  Future<User?> registerWithEmailAndPassword(
    ...
    try {
      ...
      if (e.code == 'email-already-in-use') {
        ...
        throw Exception("Failed to register (${e.code}). Please try again.");
      }
    } catch (e) {
  ...
  Future<User?> signInWithEmailAndPassword(
    ...
    try {
      ...
      if (e.code == 'user-not-found' ||
        ...
        throw Exception(
          "Invalid email format or network error. Please check your inputs.",
        );
      } else {
        throw Exception("Failed to log in (${e.code}). Please try again.");
      }
    } catch (e) {
      throw Exception("An unexpected error occurred: ${e.toString()}");
    }
