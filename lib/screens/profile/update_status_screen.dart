...
import 'package:bondnex/services/database/rtdb_service.dart';
...
class _UpdateStatusScreenState extends State<UpdateStatusScreen> {
  ...
  void initState() {
    ...
    _statusController = TextEditingController(
      text: userProvider.status ?? "What's new?",
    );
  ...
  Future<void> _onShare() async {
    ...
    try {
      // Update in RTDB for real-time live updates
      await _rtdbService.updateWhatsUpStatus(
        uid: userProvider.firebaseUid,
        mood: _statusController.text.trim(),
        listeningTo: _musicController.text.trim(),
        musicThumbnail: '', // Future: fetch thumbnail
      );

      // Update in Firestore for permanent record
