            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoTile(icon: Icons.person_outline, title: 'Name', subtitle: 'Edit full name', onTap: () => Navigator.pushNamed(context, '/change_name')),
                  _buildInfoTile(icon: Icons.email_outlined, title: 'Email', subtitle: 'View and update registered email', onTap: () {}),
                  _buildInfoTile(icon: Icons.phone_outlined, title: 'Phone Number', subtitle: 'View and update phone number', onTap: () {}),
