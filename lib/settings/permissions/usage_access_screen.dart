...
class _UsageAccessScreenState extends State<UsageAccessScreen> {
  ...
  void getUsageStats() async {
    try {
      ...
      debugPrint("Fetched app usage info size: ${info.length}");
    } catch (exception) {
          ...
          child: Column(
            ...
            children: [
              _buildSwitchTile(
                ...
                subtitle:
                    'Allow this app to read which apps you use & how long you use them.',
              ...
              Center(
                child: Text(
                  "Today's most used app: WhatsApp",
              ...
              _buildSwitchTile(
                ...
                subtitle:
                    'Notify partner if usage crosses limit (e.g., 1 hour)',
                value: _enableLimitNotifications,
                onChanged: (value) =>
                    setState(() => _enableLimitNotifications = value),
              ),
              const SizedBox(height: 24),
