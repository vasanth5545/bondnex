...
class _AccountSettingsScreenState extends State<AccountSettingsScreen> {
  ...
  void _showDisconnectDialog(UserProvider userProvider) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This will permanently unlink your current partner. You will need to share your User ID to link with a new partner. Are you sure?',
        ),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    return Consumer2<UserProvider, AppLockProvider>(
      builder: (context, userProvider, appLockProvider, child) {
        final String displayName = userProvider.userName;
        final String email = FirebaseAuth.instance.currentUser?.email ?? 'Unknown Email';
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSwitchTile(
                    ...
                    onChanged: (value) => appLockProvider.setAppLockEnabled(value),
                  ),
                  if (appLockProvider.isAppLockEnabled)
                    _buildSwitchTile(
                      icon: Icons.fingerprint,
                      title: 'Fingerprint Unlock',
                      value: appLockProvider.isFingerprintEnabled,
                      onChanged: (value) => appLockProvider.setFingerprintEnabled(value),
                    ),
                  _buildInfoTile(
        ...
        children: [
          TextField(
            controller: TextEditingController(
              text: userProvider.partnerPremiumId ?? userProvider.partnerId,
            ),
            readOnly: true,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () {
                  Clipboard.setData(
                    ClipboardData(text: userProvider.myPermanentId),
                  );
                  ScaffoldMessenger.of(context).showSnackBar(
