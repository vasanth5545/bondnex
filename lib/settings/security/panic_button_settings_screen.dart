...
class PanicButtonSettingsScreen extends StatefulWidget {
  ...
  @override
  State<PanicButtonSettingsScreen> createState() =>
      _PanicButtonSettingsScreenState();
}
...
class _PanicButtonSettingsScreenState extends State<PanicButtonSettingsScreen> {
  ...
  final TextEditingController _messageController = TextEditingController(
    text: "Emergency! I need help. This is my current location.",
  );
  ...
  Future<void> _pickContact() async {
    ...
    if (hasPermission) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Contact permission is required to pick a contact.'),
        ),
      );
    }
  }
  ...
  Future<void> _sendTestSms(String message, String recipient) async {
    ...
    final canLaunch = await canLaunchUrl(smsLaunchUri);
    if (!mounted) return;
    if (canLaunch) {
  ...
  void _testPanicButton() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'This will open your SMS app to send a test message to "${_contactController.text}". Do you want to continue?',
        ),
        actions: [
          TextButton(
          ...
          child: Column(
            ...
            children: [
              ...
              SwitchListTile(
                ...
                subtitle: Text(
                  'Enable the panic button for quick access in case of emergency.',
