...
// import 'package:bondnex/services/core/permissions_service.dart';
// import 'package:bondnex/services/database/firestore_service_dialer.dart';
      ...
      body: _isLoading
          ...
          : Center(
              child: Column(
                ...
                children: [
                  const Text(
                    "Call Log permission is required to use this feature.",
                  ),
                  ElevatedButton(
