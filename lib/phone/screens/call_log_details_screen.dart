...
class CallLogDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CallLogEntry? callLog =
        log ?? ModalRoute.of(context)?.settings.arguments as CallLogEntry?;
            ...
            child: Column(
              ...
              children: [
                ListTile(
                  ...
                  subtitle: Text(
                    callLog.contact.phones.isNotEmpty
                        ? callLog.contact.phones.first.number
                        : 'No number',
                  ),
                ),
                const Divider(),
                ...
                _buildDetailRow(
                  ...
                  'Date',
                  DateFormat.yMMMMd().format(callLog.timestamp),
                ),
                _buildDetailRow(
                  Icons.access_time,
                  'Time',
                  DateFormat.jm().format(callLog.timestamp),
                ),
                _buildDetailRow(
