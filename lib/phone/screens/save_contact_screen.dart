  ...
  void initState() {
    ...
    if (_isEditMode) {
      ...
      _emailController.text = widget.contact!.emails.isNotEmpty
          ...
          : '';
      _addressController.text = widget.contact!.addresses.isNotEmpty
          ? widget.contact!.addresses.first.address
          : '';
      _notesController.text = widget.contact!.notes.isNotEmpty
          ? widget.contact!.notes.first.note
          : '';
      _organizationController.text = widget.contact!.organizations.isNotEmpty
  ...
  Future<void> _saveContact() async {
    ...
    if (_organizationController.text.isNotEmpty) {
      if (contactToSave.organizations.isNotEmpty) {
        contactToSave.organizations.first.company = _organizationController.text
            .trim();
      } else {
        contactToSave.organizations.add(
          fc.Organization(company: _organizationController.text.trim()),
        );
      }
    }
