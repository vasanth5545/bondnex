...
class CallLogEntry {
  ...
  // Factory for creating from Firestore DocumentSnapshot (legacy)
  factory CallLogEntry.fromFirestore(DocumentSnapshot doc) {
    Map data = doc.data() as Map<String, dynamic>;
    return CallLogEntry.fromMap(data, doc.id);
  }

  // Factory for creating from Firestore Map (new array approach)
  factory CallLogEntry.fromMap(Map<dynamic, dynamic> data, [String? id]) {
    return CallLogEntry(
      id: id ?? data['id'] ?? '',
      contact: fc.Contact(
